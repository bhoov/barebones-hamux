...
> Trial run using `nbdev` for [documentation only](https://nbdev.fast.ai/tutorials/docs_only.html)
...
+ I can use VSCode's excellent [interactive python](https://code.visualstudio.com/docs/python/jupyter-support-py) mode to develop my codebase
+ I get to keep my 
